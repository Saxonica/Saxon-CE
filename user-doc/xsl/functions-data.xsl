...
<div id="fn-desc">
<h4>XSLT 2.0 and XPath 2.0 Functions</h4>
<p>Hover over a listed function to view a brief description. For full details, select the function entry.</p>
</div>
...
<xsl:variable xpath-default-namespace=""
 name="height" select="ixsl:page()/html/body/div[@id = 'wrap']/div[@id = 'main']/@prop:offsetHeight - 140"/>
...
<span class="flink" data-href="{name}">
