...
public final class AxisExpression extends Expression {
    ...
    public SequenceIterator iterate(XPathContext context) throws XPathException {
        ...
        if (item instanceof NodeInfo) {
            ...
            boolean isAtomic = (item instanceof AtomicValue);
            //if (exe instanceof NullPointerException || item == null || isCCE) {
                String appendText = " is " + ((isAtomic) ? "not a node" : "undefined");
                String code = (isAtomic) ? "XPTY0020" : "XPDY0002";
...
//                    dynamicError("Axis Expression Error on: " + cName + " " + exe.getMessage(), "XPST0010");
//                    return null;
//                }
//            }
        }
