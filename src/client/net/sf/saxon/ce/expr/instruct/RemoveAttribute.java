...
import client.net.sf.saxon.ce.trans.update.RemoveAttributeAction;
...
/**
 * The compiled form of an ixsl:remove-attribute instruction in the stylesheet.
 */

public class RemoveAttribute extends Instruction  {

    private Expression content;

    /**
     * Create a remove-attribute instruction
     * @param content an instruction to remove the attribute
     */
     ...
     * @return the static item type of the instruction. This is empty: the remove-attribute instruction
     *         returns nothing.
     */
