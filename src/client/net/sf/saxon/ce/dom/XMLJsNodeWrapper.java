...
public class XMLJsNodeWrapper implements NodeInfo, VirtualNode, SiblingCountingNode {

    protected Node node;
    private int namecode = -1;
    protected short nodeKind;
    private XMLJsNodeWrapper parent;     // null means unknown
    protected XMLJsDocumentWrapper docWrapper;
     ...
     */
    protected XMLJsNodeWrapper(Node node, XMLJsNodeWrapper parent, int index) {
        this.node = node;
        this.parent = parent;
        this.index = index;
    }
     ...
     */
    protected XMLJsNodeWrapper makeWrapper(Node node, XMLJsDocumentWrapper docWrapper) {
        if (node == null) {
    ...
    protected XMLJsNodeWrapper makeWrapper(Node node, XMLJsDocumentWrapper docWrapper,
                                   XMLJsNodeWrapper parent, int index) {
        XMLJsNodeWrapper wrapper;
        switch (node.getNodeType()) {
        case Node.DOCUMENT_NODE:
        case Node.DOCUMENT_FRAGMENT_NODE:
            return docWrapper;
        case Node.ELEMENT_NODE:
            wrapper = new XMLJsNodeWrapper(node, parent, index);
    ...
    */
    ...
    public boolean isSameNodeInfo(NodeInfo other) {
        if (!(other instanceof XMLJsNodeWrapper)) {
            return false;
        }
        XMLJsNodeWrapper ow = (XMLJsNodeWrapper)other;
    ...
    */
    ...
    private final class AttributeEnumeration implements AxisIterator {
        ...
        private int ix = 0;
        private XMLJsNodeWrapper start;
        private XMLJsNodeWrapper current;

        public AttributeEnumeration(XMLJsNodeWrapper start) {
            this.start = start;
    ...
    */
    ...
    private final class ChildEnumeration extends AxisIteratorImpl {
        ...
        private XMLJsNodeWrapper start;
        private XMLJsNodeWrapper commonParent;
        ...
        public ChildEnumeration(XMLJsNodeWrapper start,
            ...
            if (downwards) {
                ...
                commonParent = (XMLJsNodeWrapper)start.getParent();
            }
            ...
            while (true) {
                if (forwards) {
                    ...
                    if (ix >= childNodesLength) {
                        ...
                        XMLJsNodeWrapper wrapper = makeWrapper(currentDomNode, docWrapper, commonParent, ix);
