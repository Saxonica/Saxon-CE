...
public class XMLJsDocumentWrapper extends XMLJsNodeWrapper implements DocumentInfo {
    ...
    private HashMap<String, XMLJsNodeWrapper> idIndex;
    ...
    public XMLJsDocumentWrapper(com.google.gwt.xml.client.Node doc, String baseURI, Configuration config) {
        super(doc, null, 0);
    ...
    public XMLJsNodeWrapper wrap(Node node) {
        ...
        if (doc == this.node) {
            ...
            throw new IllegalArgumentException(
                "XMLJsDocumentWrapper#wrap: supplied node does not belong to the wrapped DOM document");
        }
    }
    ...
    public NodeInfo selectID(String id) {
        ...
        if (idIndex != null) {
            ...
            while (true) {
                ...
                String xmlId = ((Element)((XMLJsNodeWrapper)node).getUnderlyingNode()).getAttribute("xml:id");
                if (xmlId != null && !xmlId.isEmpty()) {
                    idIndex.put(xmlId, (XMLJsNodeWrapper)node);
                }
            }
            return idIndex.get(id);
        }
    ...
    public boolean isSameNodeInfo(NodeInfo other) {
        return other instanceof XMLJsDocumentWrapper && node == ((XMLJsDocumentWrapper)other).node;
    }
